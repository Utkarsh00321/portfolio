...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid md:grid-cols-2 my-12 md:my-16 pt-24 gap-4 relative"
    >
      ...
      <div className="z-0">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Utkarsh00321">
            <Image
              src="/github-icon.svg"
              alt="Github Icon"
              width={50}
          ...
          <Link href="https://www.linkedin.com/in/utkarsh-kadam-9a518a22b/">
            <Image
